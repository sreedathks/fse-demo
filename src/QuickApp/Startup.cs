...
namespace QuickApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            IConnectionMultiplexer redis = ConnectionMultiplexer.Connect(Configuration["ConnectionStrings:RedisConnection"]);
            ...
            services.AddSingleton(sp => RabbitHutch.CreateBus("myrabbitmq.eastus.azurecontainer.io"));
